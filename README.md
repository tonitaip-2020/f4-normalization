...
- Creating the databases:
  ...
  - Copy this for the import of the initial IMDb database: https://gist.github.com/1mehal/13c85e108cbc906f5ec34d28d75b1968
    ...
    - When prompted for the IMDb data files, leave empty, and the script will download the data files. If the script fails on Line 82 ("csvsql:error...") replace the line with this:
    - ```head -n 20 "$file" \
  | csvsql -t -i postgresql --no-constraints --blanks --tables "$table_name" \

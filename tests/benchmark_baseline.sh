...
# -h = host url
# -p = port, default 5432
pgbench -c 150 -f ../inputs/05a_queries_and_dds_baseline.sql -j 300 -n -T 3600 -U imdb imdb -h localhost -p 5433 > ../outputs/benchmark_baseline_pgbench_$(date +%Y%m%d%H%M).txt
